...
from .views import run_migrations, home_view, CustomerListCreateAPIView, OrderListCreateAPIView, register_customer_view, order_form_view, logout_view, login_redirect_view
